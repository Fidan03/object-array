...
//    if (data[i].id === 11070) {
//      console.log(`Country with id 11070 is ${data[i].shipAddress.country}`);
//      break;
//    }
//}
...
//        console.log(`The object is ${data[i]}`);
//        break
//    }
//}
...
//for (let i = 0; i < data.length; i++) {
//    if (data[i].id === 11065) {
//      console.log(`The shipName of the element is  ${data[i].shipName}`);
//      console.log(`The country of the element is  ${data[i].shipAddress.country}`);
//      console.log(`The shipName of the element is  ${data[i].shipAddress.city}`);
//      break;
//    }
//}
...
if (data[i].id === 10550) {
        let count = 0;
        for (let j=0; data[i].details.length; j++) {
          count ++;
        }
      console.log(`Details count: ${count}`);
      break
    }
}
